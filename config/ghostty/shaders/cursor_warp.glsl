// --- CONFIGURATION ---
vec4 TRAIL_COLOR = vec4(iCurrentCursorColor.rgb, 0.62); // loud preset: keep the motion, make the trail more transparent
const float DURATION = 0.24; // total animation time
...
const float TRAIL_THICKNESS = 1.08;  // 1.0 = full cursor height, 0.0 = zero height, >1.0 = funky aah
