...
![plot](./images/photo1.png)
![plot](./images/photo2.png)
![plot](./images/photo3.png)

# Installation

To install my dotfiles all you need is the command line. Dotbot handles symlinks and setup.
...
- See `SECURITY.md` before pushing changes.
- See `docs/CLEANUP_PLAN.md` for phased cleanup.
...
![plot](./images/Alfred.png)

## Amazon Q / Kiro CLI

I now use AWS' terminal tooling lineage that replaced Fig (Amazon Q Developer CLI / Kiro CLI) for shell integration and command assistance.
